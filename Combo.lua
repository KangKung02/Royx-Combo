...
Library:AddCombo(Library.Button.F1, "Kai 100 + Macro Pack", function()
    Options["Settings-Credits:Right:Downloader:Profile Url"]:SetValue("https://cdn.discordapp.com/attachments/961663721975976078/1017076321366577242/FarmLv100.json");
